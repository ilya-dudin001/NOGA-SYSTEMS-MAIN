...
необязательным и создаёт таблицу `noga_files`.
...
пока в городе остались ноги — сначала откройте форму города и снимите их в чек-листе
(или удалите ноги совсем). Управляют Owner и Правая рука, Администратор видит список
без права правки.
