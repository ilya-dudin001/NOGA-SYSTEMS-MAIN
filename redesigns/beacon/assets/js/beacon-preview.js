/* Локальная демонстрация «Маяка» без backend: включается параметром ?preview=1.
   Подменяет Telegram-вход и все методы API данными в памяти. */
(function (global) {
  "use strict";
  ...
  var razgruzy = [
    { id: 1, name: "Альфа", commission_percent: 3.5, contact: "@alpha", is_active: true, completed_orders: 18, cities_count: 4, created_by_name: "Илья", created_by_me: true, can_manage: true, created_at: "2026-05-11T09:00:00Z" },
    ...
    { id: 3, name: "Север", commission_percent: 2.8, contact: "@north", is_active: false, completed_orders: 6, cities_count: 1, created_by_name: "Илья", created_by_me: true, can_manage: true, created_at: "2026-06-02T08:30:00Z" },
    { id: 4, name: "Оскар", commission_percent: 3.2, contact: "@oskar", is_active: true, completed_orders: 0, cities_count: 0, created_by_name: "Олег", created_by_me: false, can_manage: false, created_at: "2026-07-01T10:00:00Z" },
  ];
  ...
  var nogas = [
    ...
    { id: 4, name: "Сергей", city_id: null, city_name: null, initial_city_name: "Тула", last_city_name: "Тула", is_test: false, is_active: false, can_manage: true, has_personal_access: true, created_by_name: "Илья", created_at: "2026-06-14T15:00:00Z", address: "", phones: [], telegrams: [], files: [] },
    { id: 5, name: "Дамир", city_id: 5, city_name: "Казань", initial_city_name: "Казань", last_city_name: "Казань", is_test: false, is_active: true, can_manage: false, has_personal_access: true, created_by_name: "Мария", created_at: "2026-06-20T09:00:00Z", address: "Казань, ул. Баумана, 5", phones: ["+7 900 444-55-66"], telegrams: ["@damir"], files: [] },
  ];

  var cities = [
    { id: 1, name: "Москва", status: "working", min_amount: 500000, min_amount_currency: "RUB", nogas_count: 1, razgruzy: [razgruzy[0], razgruzy[1]], can_manage: true, created_by_name: "Илья" },
    ...
    { id: 4, name: "Тула", status: "working", min_amount: 200000, min_amount_currency: "RUB", nogas_count: 0, razgruzy: [razgruzy[0]], can_manage: true, created_by_name: "Илья" },
    { id: 5, name: "Казань", status: "working", min_amount: 300000, min_amount_currency: "RUB", nogas_count: 1, razgruzy: [], can_manage: false, created_by_name: "Мария" },
    { id: 6, name: "Омск", status: "paused", min_amount: 220000, min_amount_currency: "RUB", nogas_count: 0, razgruzy: [razgruzy[2]], can_manage: true, created_by_name: "Илья" },
    { id: 7, name: "Сочи", status: "stopped", min_amount: null, min_amount_currency: null, nogas_count: 0, razgruzy: [], can_manage: true, created_by_name: "Илья" },
  ];

  var trubki = [
    { id: 1048, status: "vedut", city_id: 1, city_name: "Москва", noga_id: 1, noga_name: "Андрей", noga_owner_name: "Илья", razgruz_id: 1, razgruz_name: "Альфа", amount: 450000, amount_currency: "RUB", customer_name: "Иван Петров", customer_address: "Москва, ул. Арбат, 18", delivery: "zahod", created_by_name: "Илья", created_at: "2026-07-29T07:28:00Z", can_manage: true },
    { id: 1047, status: "zacep", city_id: 2, city_name: "Самара", noga_id: 2, noga_name: "Максим", noga_owner_name: "Олег", razgruz_id: null, razgruz_name: null, amount: 2800, amount_currency: "USD", customer_name: "Павел Орлов", customer_address: "Самара, ул. Молодогвардейская, 92", delivery: "taxi", created_by_name: "Мария", created_at: "2026-07-29T06:06:00Z", can_manage: true },
    { id: 1046, status: "zabrali", city_id: 3, city_name: "Воронеж", noga_id: 3, noga_name: "Роман", noga_owner_name: "Анна", razgruz_id: 2, razgruz_name: "Вектор", amount: 180000, amount_currency: "RUB", customer_name: "Олег Серов", customer_address: "Воронеж, Московский проспект, 44", delivery: "zahod", created_by_name: "Илья", created_at: "2026-07-28T17:01:00Z", can_manage: true },
    { id: 1045, status: "razgruzheno", city_id: 1, city_name: "Москва", noga_id: 1, noga_name: "Андрей", noga_owner_name: "Илья", razgruz_id: 1, razgruz_name: "Альфа", amount: 620000, amount_currency: "RUB", customer_name: "Антон К.", customer_address: "Москва, Ленинский проспект, 77", delivery: "taxi", created_by_name: "Мария", created_at: "2026-07-28T15:32:00Z", can_manage: true },
    { id: 1044, status: "srez", city_id: 2, city_name: "Самара", noga_id: 2, noga_name: "Максим", noga_owner_name: "Олег", razgruz_id: null, razgruz_name: null, amount: 90000, amount_currency: "RUB", customer_name: "Михаил Р.", customer_address: "Самара, ул. Ново-Садовая, 21", delivery: "zahod", created_by_name: "Илья", created_at: "2026-07-28T14:10:00Z", can_manage: true },
    { id: 1043, status: "razgruzheno", city_id: 5, city_name: "Казань", noga_id: 5, noga_name: "Дамир", noga_owner_name: "Мария", razgruz_id: null, razgruz_name: null, amount: 310000, amount_currency: "RUB", customer_name: "Тимур Г.", customer_address: "Казань, Кремлёвская, 3", delivery: "zahod", created_by_name: "Мария", created_at: "2026-07-27T19:45:00Z", can_manage: true },
    { id: 1042, status: "vedut", city_id: 3, city_name: "Воронеж", noga_id: 3, noga_name: "Роман", noga_owner_name: "Анна", razgruz_id: 2, razgruz_name: "Вектор", amount: 150000, amount_currency: "RUB", customer_name: "Семён Л.", customer_address: "Воронеж, ул. Плехановская, 9", delivery: "taxi", created_by_name: "Илья", created_at: "2026-07-27T12:20:00Z", can_manage: true },
    { id: 1041, status: "zacep", city_id: 1, city_name: "Москва", noga_id: 1, noga_name: "Андрей", noga_owner_name: "Илья", razgruz_id: 1, razgruz_name: "Альфа", amount: 520000, amount_currency: "RUB", customer_name: "Григорий Н.", customer_address: "Москва, ул. Мясницкая, 24", delivery: "zahod", created_by_name: "Мария", created_at: "2026-07-26T09:15:00Z", can_manage: true },
  ];

  var users = [
    user,
    { id: 2, telegram_id: 100000002, username: "maria", display_name: "Мария", role: "right_hand", role_label: "Правая рука", status: "active", created_at: "2026-02-01T10:00:00Z", last_seen_at: now },
    { id: 3, telegram_id: 100000003, username: "oleg", display_name: "Олег", role: "admin", role_label: "Администратор", status: "active", created_at: "2026-03-11T10:00:00Z", last_seen_at: now },
    { id: 4, telegram_id: 100000004, username: "ivan", display_name: "Иван", role: "noga", role_label: "Нога", status: "blocked", created_at: "2026-04-05T10:00:00Z", last_seen_at: now },
  ];
  ...
  global.NogaTelegram.getInitData = function () { return "beacon-preview"; };
